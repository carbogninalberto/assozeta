...
window.fetch = async (...args) => {
    ...
    if (isFormData) {
        // Raw FormData needs a boundary generated by fetch. A prebuilt Request
        // already has its boundary in its headers, which must be preserved.
...
export const apiFetch = async function (url, fetchData = {method: 'GET'}) {
    ...
    headers.set('Accept', 'application/json');
    if (fetchData.body instanceof FormData) {
        headers.delete('Content-Type');
