...
<div class="row m-0 px-4">
    <div class="col-12 col-xl-6 mb-4 mx-0">
        <SmartSelect
            customClasses={'min-w-100'}
            editable={false}
            active={false}
            bind:value={athlete.associate_data.type}
            props={{
                ...
                value: athlete?.associate_data?.type || null,
            }} />
    </div>
    <div class="col-12 col-xl-6 mb-4 mx-0">
        <SmartSelect
            customClasses={'col-12 mb-4 px-0'}
            editable={false}
            active={false}
            on:change={e => {
                athlete.associate_data.family_role = e.detail.value;
            }}
            props={{
                id: 'family_role',
                name: 'family_role',
                label: 'Ruolo nella famiglia',
                placeholder: 'Seleziona il ruolo',
                required: true,
                value: athlete?.associate_data?.family_role,
                options: [
    ...
    <div class="col-12">
        {#if athlete?.associate_data?.type === 1 || athlete?.associate_data?.type === 2}
            <h3 class="font-weight-bolder font-size-h2 mb-2">Quota Associativa</h3>
        ...
        {#if athlete?.associate_data?.type === 2 || athlete?.associate_data?.type === 3}
            <h3 class="font-weight-bolder font-size-h2 mb-2">Quota Tesseramento</h3>
