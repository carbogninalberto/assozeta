...
<div class="mb-4">
    ...
    <div class="d-flex justify-content-between align-items-center">
        <h2 class="h4 font-weight-bolder mb-0">Membri della famiglia</h2>
        <button
            ...
            <span>Aggiungi membro della famiglia</span>
        </button>
    </div>
    ...
    {#if wizardData.multipleEntryFormData.length === 0}
        <div
            ...
            Non ci sono membri della famiglia aggiunti. Clicca il pulsante sopra per aggiungere uno.
        </div>
    {:else}
