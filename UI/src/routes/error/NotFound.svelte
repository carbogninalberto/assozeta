...
<div style="margin: auto; text-align: center;">
    <div class="mb-10">
        ...
        <h2 class="display-4 text-center text-dark-75 font-weight-bolder py-3">OPS! Pagina non trovata...</h2>
    </div>
    

    <a href="/#" on:click={() => {replace('/').then( () => {location.reload()})}} class="btn btn-pill btn-transparent-primary font-weight-bolder py-4 px-8"> 
