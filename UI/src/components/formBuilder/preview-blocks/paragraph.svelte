...
<div
    ...
    <p class="mb-0">{@html props.value.replaceAll('\n', '<br>')}</p>
    {#if active}
        ...
        <div in:slide class="mb-0 mt-4 border rounded-lg p-6">
            <div class="row">
                <div class="form-group col-12 mb-4">
                    <div class="font-size-sm font-weight-bold mb-1">Testo</div>
                    <div class="input-group">
                        <textarea class="form-control form-control-sm" bind:value={props.value} />
                    </div>
                </div>
            </div>
        </div>
