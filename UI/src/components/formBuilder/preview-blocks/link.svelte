<script>
    ...
    import {FloppyDisk, Info, Link} from 'phosphor-svelte';
...
<div
    ...
    <a href={props.href} class="link link-primary font-weight-bolder" target="_blank">
        <Link size={14} weight={'duotone'} class="mr-1" />
        {props.value}
    </a>
        ...
        <div in:slide class="mb-0 mt-4 border rounded-lg p-6">
            <div class="row">
                <div class="form-group col-6 mb-4">
                    <div class="font-size-sm font-weight-bold mb-1">Testo del link</div>
                    <div class="input-group">
                        <input class="form-control form-control-sm" bind:value={props.value} />
                    </div>
                </div>
                <div class="form-group col-6 mb-4">
                    <div class="font-size-sm font-weight-bold mb-1">Link Url</div>
                    <div class="input-group">
                        <input class="form-control form-control-sm" bind:value={props.href} />
                    </div>
                </div>
            </div>
        </div>
